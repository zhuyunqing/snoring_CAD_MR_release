...
snoring <- read_exposure_data(filename = "C:/Users/86132/Desktop/复核/snoring2CAD_check/data/togsmr_habitual.txt",
                              snp_col = "SNP",
                              sep = "\t",
                              beta_col = "b",
                              se_col = "se",
...
#CAD
setwd("C:/Users/86132/Desktop/复核/snoring2CAD_check/data")
...
setwd("C:/Users/86132/Desktop/复核/snoring2CAD_check/2sampleMR/plots")
single <- mr_leaveoneout(dat, method = mr_ivw) #default就是IVW
single
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_CAD_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_CAD_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_CAD_singleplot.pdf", width=7, height=7)
...
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_MI_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_MI_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_MI_singleplot.pdf", width=7, height=7)
p3 <- mr_funnel_plot(res_single)
p3
...
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_CHF_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_CHF_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_CHF_singleplot.pdf", width=7, height=7)
p3 <- mr_funnel_plot(res_single)
p3
...
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_Angina_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_Angina_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_Angina_singleplot.pdf", width=7, height=7)
p3 <- mr_funnel_plot(res_single)
p3
...
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_SAP_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_SAP_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_SAP_singleplot.pdf", width=7, height=7)
p3 <- mr_funnel_plot(res_single)
p3
...
plot_leave1 <- mr_leaveoneout_plot1(single)
plot_leave1
ggsave(plot_leave1[[1]], file="habitual_UAP_leaveoneout.pdf", width=7, height=7)

p1<-mr_scatter_plot1(res, dat)
p1
ggsave(p1[[1]], file="habitual_UAP_scatterplot.pdf", width=7, height=7)
res_single <- mr_singlesnp(dat, all_method = c("mr_ivw"))
p2 <- mr_forest_plot1(res_single)
p2
ggsave(p2[[1]], file="habitual_UAP_singleplot.pdf", width=7, height=7)
p3 <- mr_funnel_plot(res_single)
p3
...
write.csv(result, "3snps_habitual_CAD.csv")
write.csv(test, "3snps_habitual_CAD_test.csv")